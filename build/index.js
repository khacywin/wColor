...
var Container = React__default.memo(function (props) {
    ...
    return (React__default.createElement(WColorContainer, null, props.colour.map(function (color, key) { return (React__default.createElement(WColorItemWrap, { key: _keyWColor + "-" + key },
        React__default.createElement(WColorItem, { "aria-label": color, color: color, active: color === props.select, onClick: function () { return props.fnSelected(color); }, onDoubleClick: function () { return props.fnRemove(color); } }),
...
var Selector = React__default.memo(function (props) {
    ...
    var _c = React.useState(props.select || '#54478c'), value = _c[0], setValue = _c[1];
    React.useEffect(function () {
        var _colour = [];
