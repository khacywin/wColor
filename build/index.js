...
var WColorContainer = styled__default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n  align-items: center;\n"])));
var KeyframesActive = styled.keyframes(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  0%{\n    transform: scale(.6);\n  }\n  20%{\n    transform: scale(.8);\n  }\n  100%{\n    transform: scale(1);\n  }\n"], ["\n  0%{\n    transform: scale(.6);\n  }\n  20%{\n    transform: scale(.8);\n  }\n  100%{\n    transform: scale(1);\n  }\n"])));
var CSSActive = styled.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  &::before{\n    animation: ", " 0.3s linear both;\n  }\n"], ["\n  &::before{\n    animation: ", " 0.3s linear both;\n  }\n"])), KeyframesActive);
var KeyframesItem = styled.keyframes(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  0%{\n    transform: scale(.2);\n  }\n  70%{\n    transform: scale(.9);\n  }\n  100%{\n    transform: scale(.8);\n  }\n"], ["\n  0%{\n    transform: scale(.2);\n  }\n  70%{\n    transform: scale(.9);\n  }\n  100%{\n    transform: scale(.8);\n  }\n"])));
var WColorItemWrap = styled__default.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  position: relative;\n  width: 1.4em;\n  height: 1.4em;\n  margin: .3em;\n  box-sizing: border-box;\n\n  &:hover button{\n    display: initial;\n  }\n  button{\n    position: absolute;\n    display: none;\n    z-index: 100;\n    top: 0;\n    right: 1px;\n    width: 10px;\n    height: 10px;\n    padding: 0;\n    background-color: #fff;\n    border: none;\n    border-radius: 50%;\n    cursor: pointer;\n\n    &:focus{\n      outline: 0;\n    }\n\n\n    img{\n      transform: translate(0, -2px) scale(.9);\n    }\n  }\n\n"], ["\n  position: relative;\n  width: 1.4em;\n  height: 1.4em;\n  margin: .3em;\n  box-sizing: border-box;\n\n  &:hover button{\n    display: initial;\n  }\n  button{\n    position: absolute;\n    display: none;\n    z-index: 100;\n    top: 0;\n    right: 1px;\n    width: 10px;\n    height: 10px;\n    padding: 0;\n    background-color: #fff;\n    border: none;\n    border-radius: 50%;\n    cursor: pointer;\n\n    &:focus{\n      outline: 0;\n    }\n\n\n    img{\n      transform: translate(0, -2px) scale(.9);\n    }\n  }\n\n"])));
var WColorItem = styled__default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  cursor: pointer;\n  border-radius: 0.4em;\n  background-color: inherit;\n\n  &::before{\n    position: absolute;\n    content: '';\n    border-radius: 0.2em;\n    width: 100%;\n    height: 100%;\n    top:0;\n    left:0;\n    transform: scale(0.8);\n    transition: all 0.2s linear;\n    background-color: ", ";\n    z-index: 10;\n    animation: ", " 0.2s linear;\n  }\n\n  &:hover{\n    &::before{\n      transform: scale(0.9);\n    }\n  }\n  \n  ", "\n"], ["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  cursor: pointer;\n  border-radius: 0.4em;\n  background-color: inherit;\n\n  &::before{\n    position: absolute;\n    content: '';\n    border-radius: 0.2em;\n    width: 100%;\n    height: 100%;\n    top:0;\n    left:0;\n    transform: scale(0.8);\n    transition: all 0.2s linear;\n    background-color: ", ";\n    z-index: 10;\n    animation: ", " 0.2s linear;\n  }\n\n  &:hover{\n    &::before{\n      transform: scale(0.9);\n    }\n  }\n  \n  ",
    "\n"])), function (props) { return props.color; }, KeyframesItem, function (props) { return props.active && CSSActive; });
var WColorAdd = styled__default.label(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: block;\n  width: 1.4em;\n  height: 1.4em;\n  background-color: transparent;\n  border: none;\n  cursor: pointer;\n  position: relative;\n  box-sizing: border-box;\n\n  &::before{\n    content: '';\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    background-color: #000;\n    opacity: 0.1;\n    transform: scale(0);\n    transition: transform 0.2s ease-in;\n    top: 0;\n    left: 0;\n    border-radius: 50%;\n  }\n\n  &:hover{\n    &::before{\n      transform: scale(0.8);\n    }\n  }\n\n  &:focus{\n    outline: 0;\n  }\n\n  img{\n    margin: 15%;\n    width: 70%;\n    height: 70%;\n  }\n"], ["\n  display: block;\n  width: 1.4em;\n  height: 1.4em;\n  background-color: transparent;\n  border: none;\n  cursor: pointer;\n  position: relative;\n  box-sizing: border-box;\n\n  &::before{\n    content: '';\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    background-color: #000;\n    opacity: 0.1;\n    transform: scale(0);\n    transition: transform 0.2s ease-in;\n    top: 0;\n    left: 0;\n    border-radius: 50%;\n  }\n\n  &:hover{\n    &::before{\n      transform: scale(0.8);\n    }\n  }\n\n  &:focus{\n    outline: 0;\n  }\n\n  img{\n    margin: 15%;\n    width: 70%;\n    height: 70%;\n  }\n"])));
...
var AddWrap = styled__default.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  background-color: inherit;\n\n  input{\n    height: 0;\n    width: 0;\n    padding: 0;\n    border: 0;\n    opacity: 0;\n  }\n"], ["\n  background-color: inherit;\n\n  input{\n    height: 0;\n    width: 0;\n    padding: 0;\n    border: 0;\n    opacity: 0;\n  }\n"])));
var _Add = React__default.memo(function (props) {
    return (React__default.createElement(AddWrap, null,
        React__default.createElement("input", { type: 'color', id: props.id, onBlur: function (e) { return props.fnAdd(e.target.value); } })));
});
var templateObject_1$1;

var Selector = React__default.memo(function (props) {
    var _keyWColor = _key();
    var _a = React.useState(props.select || '#54478c'), value = _a[0], setValue = _a[1];
    var _b = React.useState([]), colour = _b[0], setColour = _b[1];
    var template = [
        '#54478c',
        '#2c699a',
        '#048ba8',
    ...
    return (React__default.createElement(WColor, { dark: !!props.dark },
        React__default.createElement(WColorHeading, null, _t('Recent')),
        React__default.createElement(WColorContainer, null,
            template.map(function (color, key) { return (React__default.createElement(WColorItemWrap, { key: _keyWColor + "-template-" + key },
                React__default.createElement(WColorItem, { "aria-label": color, color: color, active: color === value, onClick: function () { return setValue(color); }, onDoubleClick: function () { return removeColour(color); } }))); }),
            colour.map(function (color, key) { return (React__default.createElement(WColorItemWrap, { key: _keyWColor + "-" + key },
                React__default.createElement(WColorItem, { "aria-label": color, color: color, active: color === value, onClick: function () { return setValue(color); }, onDoubleClick: function () { return removeColour(color); } }),
                React__default.createElement("button", { onClick: function () { return removeColour(color); }, type: 'button' },
                    React__default.createElement("img", { src: img$1, alt: 'w-color' })))); }),
            React__default.createElement(WColorAdd, { htmlFor: "id-" + _keyWColor + "-add" },
                React__default.createElement("img", { src: img, alt: 'w-color' })),
            React__default.createElement(_Add, { id: "id-" + _keyWColor + "-add", fnAdd: addColour }))));
});

var MainWrap = styled__default.div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  display: block;\n"], ["\n  display: block;\n"])));
var MainValue = styled__default.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  cursor: pointer;\n  border-radius: 5px;\n  ", "\n"], ["\n  cursor: pointer;\n  border-radius: 5px;\n  ",
    "\n"])), function (props) { return "\n    width: " + props.width + "px;\n    height: " + props.height + "px;\n    background-color: " + props.color + ";\n  "; });
var MainSelector = styled__default.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  position: absolute;\n  z-index: 999;\n  transform: translate(0, 5px);\n  display: ", ";\n"], ["\n  position: absolute;\n  z-index: 999;\n  transform: translate(0, 5px);\n  display: ", ";\n"])), function (props) { return (props.show ? 'initial' : 'none'); });
var App = React__default.memo(function (props) {
    ...
    return (React__default.createElement(MainWrap, null,
        React__default.createElement("input", { type: 'hidden', value: value, onChange: function (e) { return props.onChange(e.target.value); } }),
        ...
        React__default.createElement(MainSelector, { ref: refMenu, show: show },
            React__default.createElement(Selector, { fnSelected: function (color) { return setValue(color); } }))));
});
